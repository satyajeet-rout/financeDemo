...
const TotalUnitsSold = ({ handleBackToList }) => {
  ...
  // Total profit value
  const TotalUnitsSold = 215695.00;
    ...
    <div className="flex flex-col h-screen bg-white text-gray-800 overflow-hidden">
      ...
      <main className="flex-1 overflow-auto">
        <div className="px-4 py-3 border-b border-gray-200">
          <div className="flex items-center">
            ...
            <div className="text-sm text-gray-500">
              <span className="text-gray-500">🏢 Company-wide</span> / Total units sold
            </div>
          </div>
        ...
        <div className="border-b border-gray-200">
          ...
          {chartOpen && (
            <div className="px-4 py-3 h-64 flex flex-col items-center justify-center">
              <div className="text-4xl font-medium text-gray-800">
                {TotalUnitsSold.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}
              </div>
          ...
          >
            <div className="flex items-center">
              ...
              <div className="ml-2 text-xs text-blue-500 flex items-center">
                ...
                Sorted by Count of product name
              </div>
            </div>
            <button className="text-gray-500">
              <Maximize2 className="w-4 h-4" />
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="text-left bg-gray-50">
                    ...
                    <th className="py-2 px-4"> Count of product name</th>
                  </tr>
                </thead>
                <tbody>
                  <tr className="border-t border-gray-100">
                    <td className="py-2 px-2">1</td>
                    <td className="py-2 px-4 text-right">{TotalUnitsSold.toLocaleString('en-US', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}</td>
                  </tr>
                </tbody>
                <tfoot>
        ...
        <div className="border-b border-gray-200">
          ...
          {sqlOpen && (
            <div className="px-4 py-3 overflow-x-auto bg-gray-100">
              <pre className="text-xs text-gray-700 font-mono">
{`SELECT
  SUM(\`dbt_baskets\`.\`.product_name\`) AS \`dbt_baskets_count_of_product_name\`
FROM \`lightdash-healthcare-demo\`.\`lightdash_gardening_demo\`.\`dbt_baskets\` AS \`dbt_baskets\`



ORDER BY \`dbt_baskets_count_of_product_name\` DESC
LIMIT 500`}
              </pre>
            </div>
          )}
